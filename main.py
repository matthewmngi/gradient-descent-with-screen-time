...
# Define the training data. I'm going to look at average mental health risk as a function of average screen time.

x_train = data["avg_screen_time"] # Feature
y_train = data["avg_mental_health_risk"] # Target
...
print("`w` initialized to:", w_init)
print("`b` initialized to:", b_init)
...
plt.ylabel("Average Mental Health Risk")
plt.title("Average Screen Time vs. Average Mental Health Risk in Teenagers")
plt.show()